    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 mb-8">
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
          ...
          My journey in tech started with [your starting point], and I've been continuously learning 
          and growing in this field ever since.
        </p>
        
        <p className="text-lg text-gray-700 dark:text-gray-300">
          Currently focused on [your current focus/interests], I'm always eager to take on new 
          challenges and contribute to meaningful projects that make a difference.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Focused on web development, creating responsive and user-friendly applications.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Constantly expanding my knowledge in software engineering and new technologies.
          </p>
        </div>
